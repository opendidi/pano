...
--
-- Host: localhost    Database: VR0002
-- ------------------------------------------------------
...
INSERT INTO `u_admin` VALUES (1,'admin','6118b8407bc82fe31b6132ef7c8ee99e');
...
) ENGINE=MyISAM AUTO_INCREMENT=9388 DEFAULT CHARSET=utf8 COMMENT='场景与项目关联表（多对多）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `u_imgs_works` VALUES (9387,7031,4047);
...
) ENGINE=MyISAM AUTO_INCREMENT=7032 DEFAULT CHARSET=utf8 COMMENT='场景表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=4031 DEFAULT CHARSET=utf8 COMMENT='全景图片内容表（从表，主表为u_worksmain）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2407 DEFAULT CHARSET=utf8 COMMENT='站点配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `u_site_config` VALUES (2395,'','title','krpano100全景'),(2396,'','subtitle',''),(2397,'','desciption',''),(2398,'','address',''),(2399,'','icp',''),(2400,'','tel',''),(2401,'','qq',''),(2402,'','rewrite','1'),(2403,'','close_reg','0'),(2404,'','tempclose','0'),(2405,'','multi_pano','0'),(2406,'','closereason',''),(2364,'','global_storage','qiniu'),(2365,'','qiniu','enable'),(2366,'','oss','disable'),(2367,'','local','disable'),(2369,'qiniu','accessKey','t88I9_3xMu_kAUdFSYIUFGahyvlORsJKd0WFTf2n'),(2370,'qiniu','secretKey','_ehzZVr8MBqPDqQsMe_kLhXLeRTpvAumo0Ug1LHT'),(2371,'qiniu','bucket','ywbaba'),(2372,'qiniu','cdn_host','p0cc5qi8z.bkt.clouddn.com'),(2374,'oss','internal','0'),(2375,'oss','access_id',''),(2376,'oss','access_secret',''),(2377,'oss','bucket',''),(2378,'oss','cdn_host',''),(2379,'local','dir_path','E:/www/teapic/upload/'),(2380,'local','cdn_host','tu.bz52.cn/upload'),(2368,'qiniu','zone','zone0'),(2373,'oss','zone','zone2'),(2394,'','moban','default');
...
) ENGINE=MyISAM AUTO_INCREMENT=18431 DEFAULT CHARSET=utf8 COMMENT='项目标签与全景图片项目关联表（多对多）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `u_tag_works` VALUES (18430,26,4047);
...
INSERT INTO `u_user` VALUES (973,'13888888888','','888','46cc468df60c961d8da2326337c7aa58',1,0,'2018-04-22 09:37:38','2018-04-26 01:31:45',0,55.00);
...
) ENGINE=MyISAM AUTO_INCREMENT=4048 DEFAULT CHARSET=utf8 COMMENT='全景项目作品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `u_worksmain` VALUES (4047,973,'胜多负少','','http://p0cc5qi8z.bkt.clouddn.com/973/works/fdc81cd7f9bb380b/thumb.jpg',1449,'1f42d36a45b190a9','2018-04-22 17:40:12',0,'',0,0,1,4,0,0,0,0,0,0,'2018-04-22 17:40:12',999,0,999,0,0,'http://p0cc5qi8z.bkt.clouddn.com/');
...
-- Dump completed on 2020-09-27 14:12:11
